...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className={`${exo2.className} mt-50 mx-auto py-20 w-full px-45`}>
        <div className="px-4 sm:px-6 lg:px-8 text-center border-1 border-black rounded-3xl p-10">
          ...
          <p className="text-3xl text-black font-medium">
            Get in touch and let&apos;s discuss how we can help bring your
            vision to life
          </p>
        </div>
        <div className="border-b-4 border-black mx-20 mt-17 blur-md "></div>
      </section>
      ...
      <section className={`${exo2.className} py-20 bg-[#ebebeb]`}>
        <div className="w-full px-6 sm:px-8 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            ...
            <div>
              <div
                className={`${exo2.className} bg-[#1FE5FF] -skew-x-12 w-fit inline-block  rounded-lg`}
              >
              ...
              <p className="text-2xl text-black font-regular mb-8 mt-10">
                Have a project in mind? Questions about our services? We&apos;d
              ...
              <div className="space-y-6 mb-8">
                {contactInfo.map((item) => {
                  ...
                  return (
                    <Card
                      key={item.title}
                      className="hover:shadow-lg transition-shadow bg-black border-0"
                      style={{
                        boxShadow:
                          "-15px 15px 15px 0px #1290A1 inset, 15px -15px 15px 0px #1290A1 inset",
                      }}
                    >
                      <CardContent className="p-6">
                        <div className="flex flex-col items-start">
                          <div className="  rounded-lg flex items-center justify-center mr-4 ml-5 flex-shrink-0 p-0">
                            ...
                            <h3 className="font-semibold text-white text-2xl mb-1">
                              {item.title}
                            </h3>
                          </div>
                          <div className="ml-14">
                            ...
                            <p className="text-[#EBEBEB] text-base mt-5">
                              {item.description}
                            </p>
                          </div>
                        </div>
              ...
              <Card className="px-9 bg-[#1FE5FF]">
                <CardContent className="pt-7">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <Label className="text-2xl" htmlFor="company">
                        Company
                      </Label>
                      <Input
                        id="company"
        ...
        <div className="border-b-4 border-black mt-20 blur-md "></div>
      </section>
      <section>
        <Image src="/assets/tools.png" width={2000} height={200} alt="tools" />
      </section>
      ...
      <section
        className="w-[95%] mx-auto rounded-3xl mt-50 h-140 bg-gray-300 px-20 md:px-28 lg:px-36 xl:px-40"
        style={{
          boxShadow:
            "-36px 36px 36px 0px #0d0d0d inset, 36px -36px 36px 0px #0d0d0d inset",
          backdropFilter: "blur(78.33333587646484px)",
        }}
      >
        <div className="w-full h-full py-10 pt-5 flex flex-col items-center justify-center text-center">
          <h2
            className={`${exo2.className} text-black text-[64px] font-semibold w-full pt-5   `}
          >
            Before you reach out
          </h2>

          <p className={` font-light text-3xl text-black mb-15`}>
            You might find answers to your questions in our FAQ section or learn
            more about our process on the services page
          </p>
