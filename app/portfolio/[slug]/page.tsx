...
export default async function ProjectPage({ params }: Props) {
  ...
  return (
    <>
      <Glow top={"350px"} right={"-50px"} height="400px" />
      <Glow top={"1050px"} left={"-150px"} height="400px" />

      <Glow top={"1900px"} right={"650px"} />

      <Glow top={"2850px"} left={"250px"} height="400px" width="400px" />
      <section className="h-80 bg-black"></section>

      {/* Hero Section */}
      <section
        className={`${workSans.className} bg-[#8C8C8C]/30 transition-all duration-300 py-12`}
        style={{ boxShadow: "0 0 35px #8C8C8C inset,0 0 25px #8C8C8C" }}
      >
        <div className="w-full px-6 sm:px-8 lg:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1
                className={`text-4xl md:text-6xl font-bold text-white mb-4 drop-shadow-[0_0_20px_#1FE5FF]`}
              >
                {project.title}
              </h1>
              <p className="text-2xl text-[#1FE5FF] font-medium mb-10">
                {project.tagline}
              </p>
      ...
      <section className="py-17 ">
        <div className="w-full px-6 sm:px-8 lg:px-10 flex items-center justify-center">
          <Card className=" bg-[#1FE5FF] pl-5 py-0 rounded-3xl">
            <div className="bg-white p-8 rounded-3xl overflow-hidden">
              <CardHeader>
                <h2
                  className={`${exo2.className} text-4xl font-semibold text-[#111827]`}
                >
                  Project Overview
                </h2>
              </CardHeader>
      ...
      <section className="py-12 bg-black">
        <div className="w-full px-6 sm:px-8 lg:px-10 ">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 px-0 lg:px-10 items-stretch justify-center w-full">
            {/* Goals */}
            <Card
              className="bg-[#8C8C8C]/20 p-10 rounded-3xl "
              style={{ boxShadow: "0 0 35px #8C8C8C inset" }}
            >
              <CardHeader>
                <h2
                  className={`${exo2.className} text-4xl font-semibold text-white mt-10`}
                >
                  Project Goals
                </h2>
              </CardHeader>
      ...
      <section className={`${workSans.className} py-12 bg-black`}>
        <div className="w-full px-6 sm:px-8 md:px-10 lg:px-12">
          <h2
            className={`${exo2.className} text-4xl font-semibold text-white mb-10 text-center`}
          >
            Our Solution
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-15">
            {project.solutions.map((solution, index) => (
              <Card
                key={index}
                className="bg-[#1FE5FF] rounded-4xl pt-5 pb-0 overflow-hidden"
              >
                <div className="bg-white h-full py-5 rounded-3xl">
                  <CardContent className="pt-6">
                    <div className="flex items-start ml-5 pb-10">
                      ...
                      <p className="text-black font-regular text-xl ">
                        {solution}
                      </p>
                    </div>
                  </CardContent>
      ...
      <section className={`${workSans.className} py-12 bg-black`}>
        <div className="w-full px-6 sm:px-8 lg:px-10">
          <h2
            className={`${exo2.className} text-4xl font-semibold text-white mb-8 text-center`}
          >
            Technology Stack
          </h2>
      ...
      <section className="py-12 pt-20 mb-12 bg-black">
        <div className="w-full px-6 sm:px-8 lg:px-10">
          <h2
            className={`${exo2.className} text-4xl font-semibold text-white mb-12 text-center`}
          >
            Project Showcase
          </h2>
          ...
          <div className="max-w-[85%] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {project.results.map((result, index) => (
                <Card
                  key={index}
                  className="text-center border-1 border-[#1FE5FF]"
                >
                  <CardContent className="pt-6">
      ...
      <section
        className="w-[95%] mx-auto rounded-3xl bg-[#FFFFFF]/20 mt-20 h-140"
        style={{
          ...
          <div className="grid grid-cols-2   gap-3  items-center justify-center ">
            ...
            >
              <p className={` font-light text-3xl text-white mb-15`}>
                Get Let&apos;s discuss how we can help you achieve your goals
