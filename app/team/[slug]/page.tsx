...
export default async function TeamMemberPage({ params }: TeamMemberPageProps) {
  ...
  return (
    <>
      <Glow top={"720px"} left={"720px"} height="400px" />

      <Glow top={"1700px"} left={"-150px"} height="400px" />
      <Glow top={"2750px"} right={"450px"} height="400px" />
      {/* Hero Section */}
      <section className={`bg-[#0d0d0d]  mt-80 ${workSans.className}`}>
        <div
          className="h-90 bg-[#8C8C8C]/40 flex flex-col items-center justify-end transition-all duration-300 "
          style={{ boxShadow: "0 0 35px #8C8C8C" }}
        ></div>

        <div className="w-full px-6 sm:px-8 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-15 items-center w-full">
            {/* Profile Image */}
            ...
            {/* Profile Info */}
            <div className="lg:col-span-2 text-center lg:text-left -mt-62 lg:ml-10">
              <div className="mb-10   ">
                <h1
                ...
                <div
                  className={`flex ${workSans.className} text-xl lg:text-2xl text-white font-regular  `}
                >
              ...
              <p
                className={`${workSans.className} text-xl text-white mb-8 w-full  pr-27 mt-20   `}
              >
                {member.summary}
              </p>
      ...
      <section className="py-16 ">
        <div className="w-full px-6 sm:px-8 lg:px-10">
          <h2
            className={`${exo2.className} text-3xl md:text-4xl font-bold text-white mb-8 mt-50 text-center`}
          >
            Tools and Expertise
          </h2>
        ...
        <div className="w-full px-6 sm:px-8 lg:px-10">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4 mt-20">
              ...
              />
              <h2
                className={`${exo2.className} text-3xl md:text-4xl font-bold text-white`}
              >
                Key Achievements
              </h2>
            </div>
            <p
              className={`${exo2.className} text-2xl text-white max-w-4xl mx-auto`}
            >
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-15">
              {member.achievements.map((achievement, index) => (
                <Card
                  key={index}
                  className="hover:shadow-lg transition-shadow bg-[#1FE5FF] rounded-4xl pt-5 pb-0 overflow-hidden"
                >
                  <div className="bg-white h-full py-10 rounded-3xl">
                    <CardContent className="">
                      <div className="flex items-center ml-7 gap-3 mb-2 ">
                        ...
                        <p className="text-black text-2xl font-regular leading-relaxed">
                          {achievement}
                        </p>
                      </div>
                    </CardContent>
      ...
      <section
        className="w-[95%] rounded-3xl bg-[#FFFFFF]/20 mt-20 h-140 mx-auto"
        style={{
